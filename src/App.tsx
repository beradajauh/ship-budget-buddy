...
import DebitNoteAnalysis from "./pages/DebitNoteAnalysis";
import BudgetRealizationAnalysis from "./pages/BudgetRealizationAnalysis";
import VendorSubmitted from "./pages/VendorSubmitted";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<ProtectedRoute><Layout /></ProtectedRoute>}>
            ...
            <Route path="budget-realization-analysis" element={<BudgetRealizationAnalysis />} />
